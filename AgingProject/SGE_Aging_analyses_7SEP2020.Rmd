...
Plots for SC vs. flow proportions. Here I've combined the two CD8 subclusters from SC data, and I'm using classical monocytes from flow as analog to CD14high in SC, and the combined activated monocytes as in flow as analog to CD14low in SC. 
```{r}
for (i in 1:6){
